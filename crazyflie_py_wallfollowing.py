...
# Socket setup
HOST = "127.0.0.1"  # Must match the IMU script
...
print(f"Connected to IMU client at {addr}")

if __name__ == '__main__':

    robot = Robot()
    timestep = int(robot.getBasicTimeStep())
    print("value timestep:")
    print(timestep)
        ...
        try:
            ...
            if command:
                ...
                if command == "left":
                    ...
                    forward_desired = -0.5
                elif command == "rotateL":
                    yaw_desired = 1  # Adjust as needed
                elif command == "rotateR":
                    yaw_desired = -1  # Adjust as needed   
                elif command == "high":
                    height_diff_desired = 0.1
                elif command == "high2":
                    height_diff_desired = 0.4
                elif command == "low":
                    height_diff_desired = -0.1
                elif command == "hover":
                    forward_desired = sideways_desired = yaw_desired = height_diff_desired = 0
        except:
            pass  # Continue if there's no command
